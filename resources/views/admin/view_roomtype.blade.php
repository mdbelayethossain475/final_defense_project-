    ...
    <div class="r row p-3">
        <div class="container">
            <div class="row">
                ...
                <div class="card p-2 col-1.5" style="width: 8rem;">
                    <img src="/storage/{{ $img->img_src }}" height="70px" alt="...">

                    <div class="card-body">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{url('/room_type_image_delete'.'/'.$img->id)}}" type="button"
                                class="btn btn-danger text-white "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        </div>
